 ...
 *
 * The `narration` field is what ElevenLabs reads aloud AND what the
...
const header = {
  ...
  purpose:
    'Claude + Playwright capture · ElevenLabs narrates (George, British) · ffmpeg stitches',
};
    ...
    JSON.stringify(
      {
        ...
        viewport: VIEWPORT,
        voice: { id: 'JBFqnCBsd6RMkjVDRZzb', name: 'George', modelId: 'eleven_multilingual_v2' },
        steps: manifest,
      },
      null,
      2,
